 ...
 *   https://datatables.net/download/#dt/jq-3.7.0/dt-2.3.2/af-2.7.0/b-3.2.4/b-html5-3.2.4/b-print-3.2.4/date-1.5.6/fc-5.0.4/fh-4.0.3/r-3.0.5/sc-2.4.3/sl-3.0.1
 *
 * Included libraries:
 *   jQuery 3.7.0, DataTables 2.3.2, AutoFill 2.7.0, Buttons 3.2.4, HTML5 export 3.2.4, Print view 3.2.4, DateTime 1.5.6, FixedColumns 5.0.4, FixedHeader 4.0.3, Responsive 3.0.5, Scroller 2.4.3, Select 3.0.1
 */
